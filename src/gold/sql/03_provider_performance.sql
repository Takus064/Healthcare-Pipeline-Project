-- Requirement 3: Provider Performance Summary
...
SELECT
    ...
    SUM(cl.claim_amount) AS total_billed_amount,
...
-- Claim data để tính billed amount và status
